...
const QUERY_BUILDER = {
  ...
  GET_ORDER_DETAIL_BY_ORDER_ID: (id) => {
    const query = ` SELECT  ${ORDERS_DETAILS_FIELDS.ID},  ${ORDERS_DETAILS_FIELDS.ORDER_ID},  ${ORDERS_DETAILS_FIELDS.PRODUCT_ID},  ${ORDERS_DETAILS_FIELDS.VARIANT_ID},  ${ORDERS_DETAILS_FIELDS.USER_ID},  ${ORDERS_DETAILS_FIELDS.QUANTITY},  ${ORDERS_DETAILS_FIELDS.PRICE} ,${ORDERS_DETAILS_FIELDS.CREATED_AT} FROM  ${ORDERS_DETAILS_TABLE_NAME}   WHERE   ${ORDERS_DETAILS_FIELDS.ORDER_ID}  = ?  `;
